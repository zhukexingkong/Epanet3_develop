...
/*
CFS     cubic feet per second       立方尺/秒
GPM     gallons per minute          加仑/分            ——默认
MGD     Millions of Gallons per Day 百万加仑/天
IMGD
AFD
LPS     liter per second            升/秒
LPM     liter per minute            升/分
MLD
CMH     cube meter hour             立方米/时
CMD
*/
